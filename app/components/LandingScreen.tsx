  ...
  return (
    <main className="min-h-dvh bg-zinc-100 px-3 py-3 text-zinc-950">
      <div className="mx-auto flex min-h-[calc(100dvh-1.5rem)] w-full max-w-[420px] flex-col overflow-hidden rounded-[2.25rem] bg-white shadow-2xl shadow-zinc-950/10 ring-1 ring-zinc-200/80">
        <section className="flex flex-[0.98] flex-col px-4 pb-1 pt-3">
          ...
          <div className="grid flex-1 grid-cols-[51%_49%] items-center gap-2 overflow-hidden pt-0">
            <div className="relative z-10 flex min-w-0 flex-col justify-center pr-1">
              <h1 className="text-[clamp(1.58rem,8.15vw,2.16rem)] font-black leading-[0.92] tracking-[-0.07em] text-zinc-950">
              ...
              <p className="mt-1.5 max-w-[11rem] text-[0.7rem] font-semibold leading-[1.25rem] text-zinc-500">
                Reservas, horarios, servicios y pagos en una experiencia simple para tu peluquería.
              </p>
            </div>

            <div className="-mt-1 flex h-full min-w-0 items-center justify-end overflow-visible pl-1">
              <img
                alt="Vista previa de Clipcut en celular"
                className="h-[min(50dvh,23rem)] w-full max-w-none object-contain object-right"
        ...
        <section className="grid gap-2 bg-zinc-50 px-4 py-2">
          <article className="rounded-[1.4rem] bg-white p-3.5 shadow-sm ring-1 ring-zinc-200/70">
          ...
          <section className="rounded-[1.4rem] bg-zinc-950 p-3.5 text-white shadow-xl shadow-zinc-950/10">
