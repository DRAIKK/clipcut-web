    ...
    <main className="flex h-dvh justify-center overflow-y-auto bg-white px-3 text-zinc-950">
      <div className="flex h-dvh w-full max-w-[420px] flex-col overflow-y-auto bg-white sm:my-0 sm:rounded-[2.25rem]">
        ...
        <section className="relative grid flex-1 auto-rows-max content-end justify-items-center gap-1 bg-[#232323] px-4 pb-3 pt-1.5">
          ...
          <section className="relative z-10 w-[90%] rounded-[1.4rem] bg-[linear-gradient(45deg,#232323_0%,#2C2C2C_100%)] px-[0.5625rem] py-[0.35rem] text-[#E5E5E5] shadow-[0_18px_45px_-22px_rgba(0,0,0,0.45),0_10px_24px_-20px_rgba(15,23,42,0.28)] ring-1 ring-white/5">
          ...
          <section className="relative z-10 w-[90%] rounded-[1.4rem] bg-[linear-gradient(45deg,#232323_0%,#2C2C2C_100%)] px-[0.5625rem] py-[0.35rem] text-center shadow-[0_18px_45px_-22px_rgba(0,0,0,0.45),0_10px_24px_-20px_rgba(15,23,42,0.28)] ring-1 ring-white/5">
